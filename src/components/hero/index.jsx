...
function Hero() {
  ...
  return (
    <main
      id="home"
      className=" w-full px-4 lg:pt-24 pt-12 lg:px-6 xl:px-28 bg-[url('/HeroSection.png')] 
    ...
    >
      <div className="flex flex-col md:grid grid-cols-2 md:gap-40 justify-between w-full relative ">
        ...
        <div
          data-aos="fade-right"
          className="flex gap-8 flex-col self-center w-full relative"
        >
          <div className="flex gap-2 flex-col">
            <h1 className="text-[#FFF] font-normal font-nunitoSans md:text-2xl text-base">
              Hi, I'm Kosi Nzeako, a{" "}
            </h1>
            <p className="text-[#FFF] font-nunitoSans z-50  font-extrabold text-[rgba(254,254,254,1.00)] text-[2rem] lg:text-5xl  xl:text-[4.625rem]  md:whitespace-nowrap w-[8ch] md:w-full">
              PLATFORM ENGINEER.
            </p>
            <p className="text-[#FFF] font-nunitoSans text-xs font-light md:font-normal lg:text-2xl md:text-base lg:w-[35ch] xl:w-[50ch] w-[30ch]">
              I build and merge standard system infrastructure and tech
              solutions for engineering teams to work optimally.
            </p>
          </div>
        ...
        <div data-aos="slide-up" className=" w-full h-full ">
          ...
          <Image
            ...
            width={900}
            height={900}
            className="max-w-full lg:w-[34.55031rem] lg:h-[46.25rem] 2xl:w-full  2xl:h-full"
          />
        </div>
