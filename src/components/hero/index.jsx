  ...
  return (
    ...
    md:bg-[url('/backgroundPic.png')] bg-cover bg-no-repeat bg-center" >
      ...
      <div   className="animateOpacity block absolute top-0 left-16 md:right-2/3 md:left-20   z-0 opacity-25 hover:opacity-50 hover:animate-none">
        ...
        <div className=" absolute animateOpacity1 bottom-16 md:bottom-6 md:left-auto left-20 md:-right-24 z-0 opacity-25 hover:opacity-50 hover:animate-none lg:w-[25ch]">
        <p className="text-[0.75rem] text-[#A59F9F] font-serif">
        ...
        <div className="absolute animateOpacity -bottom-24 -left-2 xl:-bottom-24 lg:-bottom-12 md:right-1/2 z-0 opacity-25 hover:opacity-50 hover:animate-none lg:w-[25ch]">
        <p className="text-[0.75rem] text-[#A59F9F] font-serif">
        def __init__(self, input_file, cache_index=True): if isinstance(input_file, basestring): self.source_file = open(input_file,'rb') filename = input_file</p>
        </div>
        </div>
        <div data-aos="slide-up" className=" w-full h-full z-20">
        <div className="animateOpacity hidden md:block absolute top-24 right-[30%]  lg:w-[30ch] z-0 opacity-25 hover:opacity-50 hover:animate-none">
